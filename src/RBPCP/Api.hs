...
type ChanOpen  = VER :> "channels" :> Capture "client_pubkey" SendPubKey :> Capture "exp_time" BLT :> Capture "funding_txid" TxHash   :> Capture "funding_vout" Vout                   :> ReqBody '[JSON] Payment      :> Verb 'POST 201 '[JSON] PaymentResult
type ChanPay   = VER :> "channels" :> Capture "client_pubkey" SendPubKey :> Capture "exp_time" BLT :> Capture "funding_txid" TxHash   :> Capture "funding_vout" Vout                   :> ReqBody '[JSON] Payment      :> Put '[JSON] PaymentResult
type ChanClose = VER :> "channels" :> Capture "client_pubkey" SendPubKey :> Capture "exp_time" BLT :> Capture "funding_txid" TxHash   :> Capture "funding_vout" Vout     :> "close"    :> ReqBody '[JSON] Payment      :> Put '[JSON] PaymentResult
